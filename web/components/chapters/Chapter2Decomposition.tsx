  ...
  return (
    <Chapter num={2} id="cap-2" title={chapterContent.c2.title} opening={chapterContent.c2.opening}>
      <div className="mx-auto max-w-[960px] px-6">
        <PlotChart
          alt="TFT italiane vs straniere dal 1999 al 2024. Le straniere sempre sopra 1.7 nei primi anni, in declino verso 1.7. Le italiane in declino lento da 1.2 a 1.1."
      ...
      <div className="mx-auto mt-12 max-w-[680px] px-6 text-base leading-relaxed">
        <p>
          La distanza tra le due curve è strutturale: il TFT delle straniere
        ...
        <p>
          Tra il 2003 e il 2008 sono cresciute due cose: il TFT delle straniere
          ha continuato a essere alto e il loro peso sul totale è aumentato
          con i nuovi flussi migratori. La risalita aggregata del TFT italiano
          in quegli anni è stata in larga misura un effetto composizione, non
          un cambiamento di comportamento.
        </p>
        <p>
          Da circa il 2010 entrambi i driver si sono esauriti: il TFT delle
